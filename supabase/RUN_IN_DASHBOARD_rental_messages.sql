-- ===========================================================================
-- Rental message inbox — run this in the Supabase SQL Editor.
-- Safe to re-run (if not exists / or replace).
-- Requires the text_rentals migration to have been applied already.
-- ===========================================================================
...
select table_name from information_schema.tables
 where table_schema = 'public' and table_name = 'text_rental_messages';

select routine_name from information_schema.routines
 where routine_schema = 'public' and routine_name = 'text_rental_store_sms';
